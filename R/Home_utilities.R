...
#' of his utility  bills starting in 1999. There are months missing, a few transcription errors, etc. This
#' version of the data goes up to November 2018. The data will be updated from time to time as  new bills
#' come in.
#'
#' @docType data
#'
