...
#' @docType data
#'
#' @details `Schrek_1950` is a reconstruction of the "raw" data behind the
...
#'
#'
#' @usage data(Schrek_1950)
#'
#' @format  `Schrek_1950`: A data.frame object with one row for each patient.
#'
#'
#' - `age`: The patient's age. This  is rounded down to the nearest decade, since Schrek et al. presented
#' ages  as 20, 30, 40, 50, ...
#' - `site`: The site of the patient's tumor: "lung", "lip", "larynx", "other
#' - `smoker`: Whether the patient smoked: "smoker", "nonsmoker". More accurate names for the
...
#' @keywords datasets
#'
#' @source  Reconstructed from Schrek, Baker, et al.,
#' "Tobacco Smoking as an Etiologic Factor in Disease. I. Cancer"
#' Cancer Research 1950;10:49-58.
